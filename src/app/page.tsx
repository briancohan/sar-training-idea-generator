          ...
          <svg
            ...
            <defs>
              <radialGradient id='759c1415-0410-454c-8f7c-9a820de03641'>
                ...
                <stop offset={1} stopColor='#E9C135' />
              </radialGradient>
            </defs>
          </svg>
          <div className='mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left'>
            <h2 className='text-3xl font-bold tracking-tight text-white sm:text-4xl'>
              Keep SAR Interesting.
              <br />
            ...
            <div className='mt-10 flex items-center justify-center gap-x-6 lg:justify-start'>
              ...
              <Link href='/explore' className='text-sm font-semibold leading-6 text-white'>
                Explore SAR Topics <span aria-hidden='true'>→</span>
              </Link>
            </div>
          </div>
          <div className='relative mt-16 lg:mt-8 flex items-center justify-center'>
            <div className='bg-white overflow-hidden rounded-full absolute left-12'>
              <Sunburst config={{ staticPlot: true }} className='w-96 h-96' />
            </div>
          </div>
        </div>
      </div>
